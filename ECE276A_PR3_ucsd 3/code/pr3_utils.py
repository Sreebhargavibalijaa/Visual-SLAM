...
def visualize_trajectory_2d_slam(pose, mean = None, path_name="Path update after Visual-inertial SLAM",show_ori=False):
    '''
...
def visualize_trajectory_2d_mapping(pose, mean = None, path_name="Path update after Landmark mapping",show_ori=False):
    '''
    function to visualize the trajectory in 2D
    Input:
        pose:   4*4*N matrix representing the camera pose, 
    ...
    return fig, ax
def visualize_trajectory_2d_imu(pose, mean = None, path_name="Path update through IMU",show_ori=False):
    '''
    function to visualize the trajectory in 2D
    Input:
        pose:   4*4*N matrix representing the camera pose, 
    ...
    ax.axis('equal')
    ax.grid(False)
    ax.legend(['Legend'], loc='top right')
